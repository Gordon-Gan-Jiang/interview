...
3. CMS：获取最短停顿时间为目标，尤其重视服务的响应速度，采用三色标记+Incremental update算法；
...
## JVM 分区（内存区域），1.7 和 1.8 的区别，使用元空间的意义
...
* 如果s1和eden区将存活的对象复制到s2，s2再复制到s1, 当在servivor 区中累计对象达到空间的50%，将年龄较大的放入老年区
...
![image-20211009200858087](/Users/gankang/Library/Application Support/typora-user-images/image-20211009200858087.png)
